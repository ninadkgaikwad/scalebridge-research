...
TARGET_BUILDING = "RetailStripmall"
TARGET_WEATHER = "Seattle"

OUTPUT_ROOT = Path("scratch") / "p1_compact_retailstripmall_seattle_1day_smoke"
...
def main():
    ...
    lines = []
    lines.append("RetailStripmall Seattle 1-Day opyplus Smoke Test")
    lines.append("=" * 80)
