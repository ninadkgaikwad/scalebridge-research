...
TARGET_BUILDING = "RetailStandalone"
TARGET_WEATHER = "Seattle"

OUTPUT_ROOT = Path("scratch") / "p1_compact_retailstandalone_seattle_1day_smoke"
...
def main():
    ...
    lines = []
    lines.append("RetailStandalone Seattle 1-Day opyplus Smoke Test")
    lines.append("=" * 80)
