...
def parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--ml-input-lag", type=int, default=12)
    p.add_argument("--ml-target-horizon", type=int, default=6)
...
def main() -> int:
    ...
    aggregation_manifest["temporal_policies"] = {
        "ml_sciml": [
            {"policy_name": name, "parameters": ml_parameter_map[name]}
